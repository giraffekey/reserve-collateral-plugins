 ...
 * @notice Collateral plugin for a Maple Finance pool of unpegged collateral, such as wETH.
 * Expected: {tok} != {ref}, {ref} == {target}, {target} != {UoA}
 */
contract MaplePoolSelfReferentialCollateral is AppreciatingFiatCollateral {
    ...
    /// @param pool_ The Maple Finance pool
    constructor(
    ...
    function _underlyingRefPerTok() internal view override returns (uint192) {
        uint256 rate = FIX_ONE.mul(pool.totalAssets()).div(pool.totalSupply());
