...
import "./MaplePoolFiatCollateral.sol";

/**
 * @title MaplePoolNonFiatCollateral
 * @notice Collateral plugin for a Maple Finance pool of non-fiat collateral that requires default checks,
...
contract MaplePoolNonFiatCollateral is MaplePoolFiatCollateral {
    ...
    constructor(
        ...
        IPool pool_
    ) MaplePoolFiatCollateral(config, revenueHiding, pool_) {
